...
function [PSNR] = code_basekey(inputName, baseName, fixvalName, modeName, outputName, TH_fix, TH_div, quality)
    ...
    for x = 1:repeat_height
        for y = 1:repeat_width
            ...
            [b4_enc_base_pix, b4_enc_base_fixval, b4_enc_fixval, pre_mode, decode_block] = encode_top(yuv_block, TH_fix, TH_div, quality);
