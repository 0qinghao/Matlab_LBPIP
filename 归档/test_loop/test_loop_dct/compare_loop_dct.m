function [sae_t_cell, size_t_cell, sae_l_cell, size_l_cell, err_cell] = compare_loop_dct()
    ...
    for x = 5:20
        ...
        for y = 5:20
            ...
            sae_t_cell{test_cnt} = SAE_t;
            size_t_cell{test_cnt} = SIZE_t;
            sae_l_cell{test_cnt} = SAE_l;
            size_l_cell{test_cnt} = SIZE_l;
            err_cell{test_cnt} = err;
